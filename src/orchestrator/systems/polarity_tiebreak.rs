...
//! the table is generated by `AnimationModelTraining scripts/orchestrator_router/derive_polarity_terms.py`
...
//!
//! `AnimationModelTraining scripts/orchestrator_router/polarity.py` is the reference: it produced the
