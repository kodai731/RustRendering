...
//! the table is generated by `AnimationModelTraining scripts/helm_router/derive_polarity_terms.py`
...
//!
//! `AnimationModelTraining scripts/helm_router/polarity.py` is the reference: it produced the
