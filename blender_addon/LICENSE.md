...
``bpy`` API are licensed under the GNU General Public License, version 2 or
(at the user's option) any later version (**GPL-2.0-or-later**) -- the
license required by the Blender 4.2+ extension policy.
...
GPL-2.0-or-later terms for their Python sources; the difference is which
...
A copy of the GPL is available at https://www.gnu.org/licenses/gpl-2.0.html .

## Files covered by GPL-2.0-or-later
