...
declare_style_group! {
    FlameStyleMotion, extract_motion_style, apply_motion_style, effect {
        direct {
            ...
            meander_frequency: f32 => meander_frequency,
...
declare_style_group! {
    FlameStyleTexture, extract_texture_style, apply_texture_style, effect {
        direct {
            ...
            noise_aniso_y: f32 => noise_aniso_y,
            density_map_gain: f32 => density_map_gain,
            density_map_scale: f32 => density_map_scale,
            soot_gain: f32 => soot_gain,
            soot_threshold: f32 => soot_threshold,
...
declare_style_group! {
    FlameStyleOptics, extract_optics_style, apply_optics_style, effect {
        direct {
            ...
            glow_gain: f32 => glow_gain,
            glow_threshold: f32 => glow_threshold,
    ...
    fn full_style() -> FlameStyle {
        FlameStyle {
            ...
            texture: FlameStyleTexture {
                ...
                density_map_gain: Some(1.2),
                density_map_scale: Some(0.8),
                soot_gain: Some(0.6),
                soot_threshold: Some(1.2),
