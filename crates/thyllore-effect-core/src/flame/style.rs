...
declare_style_group! {
    FlameStyleTexture, extract_texture_style, apply_texture_style, effect {
        direct {
            ...
            mix_lo: f32 => mix_lo,
            mix_hi: f32 => mix_hi,
            mix_height_gain: f32 => mix_height_gain,
            mix_scale: f32 => mix_scale,
            mix_radial_gain: f32 => mix_radial_gain,
...
declare_style_group! {
    FlameStyleOptics, extract_optics_style, apply_optics_style, effect {
        direct {
            ...
            density_exp: f32 => density_exp,
            temp_exp: f32 => temp_exp,
            wien_c_k: f32 => wien_c_k,
