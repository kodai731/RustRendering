...
declare_flame_parameters! { effect =>
    ...
    mix_lo: Style = [effect.mix_lo],
    mix_hi: Style = [effect.mix_hi],
    mix_height_gain: Style = [effect.mix_height_gain],
    mix_scale: Style = [effect.mix_scale],
    mix_radial_gain: Style = [effect.mix_radial_gain],
    density_exp: Style = [effect.density_exp],
    temp_exp: Style = [effect.temp_exp],
    wien_c_k: Style = [effect.wien_c_k],
